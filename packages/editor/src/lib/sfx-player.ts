...
export const SFX = {
  gridSnap: '/buildx/audios/sfx/grid_snap.mp3',
  itemDelete: '/buildx/audios/sfx/item_delete.mp3',
  itemPick: '/buildx/audios/sfx/item_pick.mp3',
  itemPlace: '/buildx/audios/sfx/item_place.mp3',
  itemRotate: '/buildx/audios/sfx/item_rotate.mp3',
  structureBuild: '/buildx/audios/sfx/structure_build.mp3',
  structureDelete: '/buildx/audios/sfx/structure_delete.mp3',
} as const
